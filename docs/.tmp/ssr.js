...
const Toolbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.timeElapsed === void 0 && $$bindings.timeElapsed && timeElapsed !== void 0) $$bindings.timeElapsed(timeElapsed);
	if ($$props.actions === void 0 && $$bindings.actions && actions !== void 0) $$bindings.actions(actions);
	$$result.css.add(css);

	return `<div class="${"toolbar svelte-i1phwf"}"><h3><b>${escape(formatTime(timeElapsed))}</b></h3>
  <div>${each(actions, action => `<button class="${"svelte-i1phwf"}">${escape(action.charAt(0).toUpperCase().concat(action.slice(1)))}
      </button>`)}</div>
</div>`;
});
...
const Cell = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.isRunning === void 0 && $$bindings.isRunning && isRunning !== void 0) $$bindings.isRunning(isRunning);
...
const Puzzle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.isRevealing === void 0 && $$bindings.isRevealing && isRevealing !== void 0) $$bindings.isRevealing(isRevealing);
	if ($$props.isComplete === void 0 && $$bindings.isComplete && isComplete !== void 0) $$bindings.isComplete(isComplete);
	if ($$props.isChecking === void 0 && $$bindings.isChecking && isChecking !== void 0) $$bindings.isChecking(isChecking);
	if ($$props.isRunning === void 0 && $$bindings.isRunning && isRunning !== void 0) $$bindings.isRunning(isRunning);
...
const Clue = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.isBlurred === void 0 && $$bindings.isBlurred && isBlurred !== void 0) $$bindings.isBlurred(isBlurred);
	...
	return `<li${add_attribute("this", element, 1)}><button class="${[
		"clue " + escape(custom) + " svelte-1ltdnsv",
		(isDisableHighlight ? "is-disable-highlight" : "") + " " + (isNumberFocused ? "is-number-focused" : "") + " " + (isDirectionFocused ? "is-direction-focused" : "") + " " + (isFilled ? "is-filled" : "") + " " + (isBlurred ? "is-blurred" : "")
	].join(" ").trim()}"><strong class="${"svelte-1ltdnsv"}">${escape(number)}</strong>
    ${escape(clue)}</button>
</li>`;
});
...
const css$5 = {
	code: ".list.svelte-uh7iqm{position:relative;max-height:var(--clue-list-height);margin-bottom:2em;overflow:auto}p.svelte-uh7iqm{font-family:var(--font);color:var(--main-color);font-weight:700;text-transform:uppercase;padding-left:calc(2.5em + 6px);padding-bottom:0.5em;font-size:0.85em;border-bottom:1px solid var(--accent-color);margin:0}ul.svelte-uh7iqm{list-style-type:none;padding-left:0;margin:0;margin-top:1em}.svelte-uh7iqm::-moz-scrollbar{width:9px}.svelte-uh7iqm::-webkit-scrollbar{width:9px}.svelte-uh7iqm::-moz-scrollbar-track{box-shadow:none;border-radius:8px;background-color:var(--accent-color)}.svelte-uh7iqm::-webkit-scrollbar-track{box-shadow:none;border-radius:8px;background-color:var(--accent-color)}.svelte-uh7iqm::scrollbar-thumb{border-radius:8px;background-color:var(--scrollbar-color);box-shadow:none}.svelte-uh7iqm::-moz-scrollbar-thumb{background-color:var(--scrollbar-color);border-radius:6px}.svelte-uh7iqm::-webkit-scrollbar-thumb{background-color:var(--scrollbar-color);border-radius:6px}",
	map: "{\"version\":3,\"file\":\"ClueList.svelte\",\"sources\":[\"ClueList.svelte\"],\"sourcesContent\":[\"<script>\\n  import Clue from \\\"./Clue.svelte\\\";\\n\\n  export let direction;\\n  export let clues;\\n  export let focusedClueNumbers;\\n  export let isDirectionFocused;\\n  export let onClueFocus;\\n  export let isDisableHighlight;\\n  export let shouldShowClues;\\n</script>\\n\\n<p>{direction}</p>\\n<div class=\\\"list\\\">\\n  <ul>\\n    {#each clues as clue}\\n      <Clue\\n        clue=\\\"{clue.clue}\\\"\\n        number=\\\"{clue.number}\\\"\\n        custom=\\\"{clue.custom}\\\"\\n        isFilled=\\\"{clue.isFilled}\\\"\\n        isNumberFocused=\\\"{focusedClueNumbers[direction] === clue.number}\\\"\\n        isDirectionFocused=\\\"{isDirectionFocused}\\\"\\n        isDisableHighlight=\\\"{isDisableHighlight}\\\"\\n        isBlurred=\\\"{!shouldShowClues}\\\"\\n        onFocus=\\\"{() => onClueFocus(clue)}\\\" />\\n    {/each}\\n  </ul>\\n</div>\\n\\n<style>\\n  .list {\\n    position: relative;\\n    max-height: var(--clue-list-height);\\n    margin-bottom: 2em;\\n    overflow: auto;\\n  }\\n\\n  p {\\n    font-family: var(--font);\\n    color: var(--main-color);\\n    font-weight: 700;\\n    text-transform: uppercase;\\n    padding-left: calc(2.5em + 6px);\\n    padding-bottom: 0.5em;\\n    font-size: 0.85em;\\n    border-bottom: 1px solid var(--accent-color);\\n    margin: 0;\\n  }\\n\\n  ul {\\n    list-style-type: none;\\n    padding-left: 0;\\n    margin: 0;\\n    margin-top: 1em;\\n  }\\n\\n  ::-moz-scrollbar {\\n    width: 9px;\\n  }\\n  ::-webkit-scrollbar {\\n    width: 9px;\\n  }\\n\\n  ::-moz-scrollbar-track {\\n    box-shadow: none;\\n    border-radius: 8px;\\n    background-color: var(--accent-color);\\n  }\\n  ::-webkit-scrollbar-track {\\n    box-shadow: none;\\n    border-radius: 8px;\\n    background-color: var(--accent-color);\\n  }\\n  ::scrollbar-thumb {\\n    border-radius: 8px;\\n    background-color: var(--scrollbar-color);\\n    box-shadow: none;\\n  }\\n  ::-moz-scrollbar-thumb {\\n    background-color: var(--scrollbar-color);\\n    border-radius: 6px;\\n  }\\n  ::-webkit-scrollbar-thumb {\\n    background-color: var(--scrollbar-color);\\n    border-radius: 6px;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA+BE,KAAK,cAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,IAAI,AAChB,CAAC,AAED,CAAC,cAAC,CAAC,AACD,WAAW,CAAE,IAAI,MAAM,CAAC,CACxB,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,WAAW,CAAE,GAAG,CAChB,cAAc,CAAE,SAAS,CACzB,YAAY,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/B,cAAc,CAAE,KAAK,CACrB,SAAS,CAAE,MAAM,CACjB,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,cAAc,CAAC,CAC5C,MAAM,CAAE,CAAC,AACX,CAAC,AAED,EAAE,cAAC,CAAC,AACF,eAAe,CAAE,IAAI,CACrB,YAAY,CAAE,CAAC,CACf,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,GAAG,AACjB,CAAC,cAED,gBAAgB,AAAC,CAAC,AAChB,KAAK,CAAE,GAAG,AACZ,CAAC,cACD,mBAAmB,AAAC,CAAC,AACnB,KAAK,CAAE,GAAG,AACZ,CAAC,cAED,sBAAsB,AAAC,CAAC,AACtB,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,IAAI,cAAc,CAAC,AACvC,CAAC,cACD,yBAAyB,AAAC,CAAC,AACzB,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,IAAI,cAAc,CAAC,AACvC,CAAC,cACD,iBAAiB,AAAC,CAAC,AACjB,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,IAAI,iBAAiB,CAAC,CACxC,UAAU,CAAE,IAAI,AAClB,CAAC,cACD,sBAAsB,AAAC,CAAC,AACtB,gBAAgB,CAAE,IAAI,iBAAiB,CAAC,CACxC,aAAa,CAAE,GAAG,AACpB,CAAC,cACD,yBAAyB,AAAC,CAAC,AACzB,gBAAgB,CAAE,IAAI,iBAAiB,CAAC,CACxC,aAAa,CAAE,GAAG,AACpB,CAAC\"}"
};
...
const ClueList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.isDisableHighlight === void 0 && $$bindings.isDisableHighlight && isDisableHighlight !== void 0) $$bindings.isDisableHighlight(isDisableHighlight);
	if ($$props.shouldShowClues === void 0 && $$bindings.shouldShowClues && shouldShowClues !== void 0) $$bindings.shouldShowClues(shouldShowClues);
	$$result.css.add(css$5);

	return `<p class="${"svelte-uh7iqm"}">${escape(direction)}</p>
<div class="${"list svelte-uh7iqm"}"><ul class="${"svelte-uh7iqm"}">${each(clues, clue => `${validate_component(Clue, "Clue").$$render(
		$$result,
		{
			clue: clue.clue,
			number: clue.number,
...
const CompletedMessage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${ `<div class="${"completed svelte-110gu3o"}"><div class="${"content svelte-110gu3o"}"><div class="${"message svelte-110gu3o"}">${slots.default ? slots.default({}) : ``}</div>

      <button class="${"svelte-110gu3o"}">Admire puzzle</button></div>

    ${showConfetti
		? `<div class="${"confetti svelte-110gu3o"}">${validate_component(Confetti, "Confetti").$$render($$result, {}, {}, {})}</div>`
		: ``}</div>
  <div class="${"curtain svelte-110gu3o"}"></div>`
	}`;
});
...
const css$a = {
	code: ".start.svelte-77b58b{position:absolute;top:min(50%, 15em);left:50%;background-color:var(--bg-color);transform:translate(-50%, -50%);border-radius:4px;z-index:100;box-shadow:0 4px 8px 4px rgba(0, 0, 0, 0.2);font-family:var(--font)}.curtain.svelte-77b58b{position:absolute;top:0;right:-2px;bottom:0;left:0;background-color:var(--bg-color);opacity:0.9;cursor:pointer;z-index:1}button.svelte-77b58b{cursor:pointer;font-size:1em;font-family:var(--font);background-color:var(--accent-color);border-radius:4px;color:var(--main-color);padding:0.75em;border:none;font-weight:400;transition:background-color 150ms}button.svelte-77b58b:hover{background-color:var(--secondary-highlight-color)}.content.svelte-77b58b{position:relative;display:flex;flex-direction:column;align-items:center;padding:2em}.message.svelte-77b58b{margin-bottom:1em;text-align:center}",
	map: "{\"version\":3,\"file\":\"StartMessage.svelte\",\"sources\":[\"StartMessage.svelte\"],\"sourcesContent\":[\"<script>\\n  import { fade } from \\\"svelte/transition\\\";\\n\\n  export let isRunning;\\n\\n  let isOpen = true;\\n\\n  function close() {\\n    isOpen = false;\\n    isRunning = true;\\n  }\\n</script>\\n  \\n{#if isOpen}\\n  <div class=\\\"start\\\" transition:fade=\\\"{{ y: 20 }}\\\">\\n    <div class=\\\"content\\\">\\n      <div class=\\\"message\\\">\\n        <slot />\\n      </div>\\n\\n      <button on:click=\\\"{close}\\\">Start puzzle</button>\\n    </div>\\n  </div>\\n  <div\\n    class=\\\"curtain\\\"\\n    transition:fade=\\\"{{ duration: 250 }}\\\"\\n    on:click=\\\"{close}\\\"/>\\n{/if}\\n\\n<style>\\n  .start {\\n    position: absolute;\\n    top: min(50%, 15em);\\n    left: 50%;\\n    background-color: var(--bg-color);\\n    transform: translate(-50%, -50%);\\n    border-radius: 4px;\\n    z-index: 100;\\n    box-shadow: 0 4px 8px 4px rgba(0, 0, 0, 0.2);\\n    font-family: var(--font);\\n  }\\n\\n  .curtain {\\n    position: absolute;\\n    top: 0;\\n    right: -2px;\\n    bottom: 0;\\n    left: 0;\\n    background-color: var(--bg-color);\\n    opacity: 0.9;\\n    cursor: pointer;\\n    z-index: 1;\\n  }\\n\\n  button {\\n    cursor: pointer;\\n    font-size: 1em;\\n    font-family: var(--font);\\n    background-color: var(--accent-color);\\n    border-radius: 4px;\\n    color: var(--main-color);\\n    padding: 0.75em;\\n    border: none;\\n    font-weight: 400;\\n    transition: background-color 150ms;\\n  }\\n\\n  button:hover {\\n    background-color: var(--secondary-highlight-color);\\n  }\\n\\n  .content {\\n    position: relative;\\n    display: flex;\\n    flex-direction: column;\\n    align-items: center;\\n    padding: 2em;\\n  }\\n\\n  .message {\\n    margin-bottom: 1em;\\n    text-align: center;\\n  }\\n</style>\\n  \"],\"names\":[],\"mappings\":\"AA8BE,MAAM,cAAC,CAAC,AACN,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,GAAG,CAAC,CAAC,IAAI,CAAC,CACnB,IAAI,CAAE,GAAG,CACT,gBAAgB,CAAE,IAAI,UAAU,CAAC,CACjC,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CAChC,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC5C,WAAW,CAAE,IAAI,MAAM,CAAC,AAC1B,CAAC,AAED,QAAQ,cAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,gBAAgB,CAAE,IAAI,UAAU,CAAC,CACjC,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,MAAM,cAAC,CAAC,AACN,MAAM,CAAE,OAAO,CACf,SAAS,CAAE,GAAG,CACd,WAAW,CAAE,IAAI,MAAM,CAAC,CACxB,gBAAgB,CAAE,IAAI,cAAc,CAAC,CACrC,aAAa,CAAE,GAAG,CAClB,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,OAAO,CAAE,MAAM,CACf,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,gBAAgB,CAAC,KAAK,AACpC,CAAC,AAED,oBAAM,MAAM,AAAC,CAAC,AACZ,gBAAgB,CAAE,IAAI,2BAA2B,CAAC,AACpD,CAAC,AAED,QAAQ,cAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,GAAG,AACd,CAAC,AAED,QAAQ,cAAC,CAAC,AACR,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,MAAM,AACpB,CAAC\"}"
};

const StartMessage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let { isRunning } = $$props;

	if ($$props.isRunning === void 0 && $$bindings.isRunning && isRunning !== void 0) $$bindings.isRunning(isRunning);
	$$result.css.add(css$a);

	return `${ `<div class="${"start svelte-77b58b"}"><div class="${"content svelte-77b58b"}"><div class="${"message svelte-77b58b"}">${slots.default ? slots.default({}) : ``}</div>

      <button class="${"svelte-77b58b"}">Start puzzle</button></div></div>
  <div class="${"curtain svelte-77b58b"}"></div>`
	}`;
});
...
const Crossword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.showStartMessage === void 0 && $$bindings.showStartMessage && showStartMessage !== void 0) $$bindings.showStartMessage(showStartMessage);
	...
	if ($$props.showConfetti === void 0 && $$bindings.showConfetti && showConfetti !== void 0) $$bindings.showConfetti(showConfetti);
	if ($$props.storageKey === void 0 && $$bindings.storageKey && storageKey !== void 0) $$bindings.storageKey(storageKey);
	if ($$props.showKeyboard === void 0 && $$bindings.showKeyboard && showKeyboard !== void 0) $$bindings.showKeyboard(showKeyboard);
	if ($$props.keyboardStyle === void 0 && $$bindings.keyboardStyle && keyboardStyle !== void 0) $$bindings.keyboardStyle(keyboardStyle);
	...
	do {
		...
		? `<article class="${"svelte-crossword svelte-186p9qm"}"${add_attribute("style", inlineStyles, 0)}>${slots.toolbar
			...
			: `
      ${validate_component(Toolbar, "Toolbar").$$render($$result, { timeElapsed, actions }, {}, {})}
    `}
    ...
    ${!isRunning && !isComplete
			? `${validate_component(StartMessage, "StartMessage").$$render(
					$$result,
					{ isRunning },
					{
						isRunning: $$value => {
					...
					},
					{
						...
						? slots.message({})
						: `
          <h3 class="${"svelte-186p9qm"}">${escape(isPaused ? "Your puzzle is paused." : "Ready?")}</h3>
        `}`
					}
				)}`
			: ``}
    ...
    ${isComplete && !isRevealing && showCompleteMessage
			? `${validate_component(CompletedMessage, "CompletedMessage").$$render($$result, { showConfetti }, {}, {
					...
					? slots.message({})
					: `
          <h3 class="${"svelte-186p9qm"}">You solved it in ${escape(formatTime(timeElapsed))}!</h3>
        `}`
				})}`
			: ``}</article>`
		: ``}`;
