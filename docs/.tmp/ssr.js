...
const ClueList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<p class="${"svelte-1fbvob"}">${escape(direction)}</p>
<div class="${"list svelte-1fbvob"}"><ul class="${"svelte-1fbvob"}">${each(clues, clue => `${validate_component(Clue, "Clue").$$render(
		$$result,
		{
			clue: clue.clue,
			number: clue.number,
