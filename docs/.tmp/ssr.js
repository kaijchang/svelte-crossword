...
const css$a = {
	code: ".start.svelte-1vlhcvg{position:absolute;top:min(50%, 15em);left:50%;background-color:var(--bg-color);transform:translate(-50%, -50%);border-radius:4px;z-index:100;box-shadow:0 4px 8px 4px rgba(0, 0, 0, 0.2);font-family:var(--font)}.curtain.svelte-1vlhcvg{position:absolute;top:0;right:-2px;bottom:0;left:0;background-color:var(--bg-color);opacity:0.9;cursor:pointer;z-index:1}button.svelte-1vlhcvg{cursor:pointer;font-size:1em;font-family:var(--font);background-color:var(--accent-color);border-radius:4px;color:var(--main-color);padding:0.75em;border:none;font-weight:400;transition:background-color 150ms}button.svelte-1vlhcvg:hover{background-color:var(--secondary-highlight-color)}.content.svelte-1vlhcvg{position:relative;display:flex;flex-direction:column;align-items:center;padding:2em}.message.svelte-1vlhcvg{margin-bottom:1em}",
	map: "{\"version\":3,\"file\":\"StartMessage.svelte\",\"sources\":[\"StartMessage.svelte\"],\"sourcesContent\":[\"<script>\\n  import { fade } from \\\"svelte/transition\\\";\\n\\n  export let isRunning;\\n\\n  let isOpen = true;\\n\\n  function close() {\\n    isOpen = false;\\n    isRunning = true;\\n  }\\n</script>\\n  \\n{#if isOpen}\\n  <div class=\\\"start\\\" transition:fade=\\\"{{ y: 20 }}\\\">\\n    <div class=\\\"content\\\">\\n      <div class=\\\"message\\\">\\n        <slot />\\n      </div>\\n\\n      <button on:click=\\\"{close}\\\">Start puzzle</button>\\n    </div>\\n  </div>\\n  <div\\n    class=\\\"curtain\\\"\\n    transition:fade=\\\"{{ duration: 250 }}\\\"\\n    on:click=\\\"{close}\\\"/>\\n{/if}\\n\\n<style>\\n  .start {\\n    position: absolute;\\n    top: min(50%, 15em);\\n    left: 50%;\\n    background-color: var(--bg-color);\\n    transform: translate(-50%, -50%);\\n    border-radius: 4px;\\n    z-index: 100;\\n    box-shadow: 0 4px 8px 4px rgba(0, 0, 0, 0.2);\\n    font-family: var(--font);\\n  }\\n\\n  .curtain {\\n    position: absolute;\\n    top: 0;\\n    right: -2px;\\n    bottom: 0;\\n    left: 0;\\n    background-color: var(--bg-color);\\n    opacity: 0.9;\\n    cursor: pointer;\\n    z-index: 1;\\n  }\\n\\n  button {\\n    cursor: pointer;\\n    font-size: 1em;\\n    font-family: var(--font);\\n    background-color: var(--accent-color);\\n    border-radius: 4px;\\n    color: var(--main-color);\\n    padding: 0.75em;\\n    border: none;\\n    font-weight: 400;\\n    transition: background-color 150ms;\\n  }\\n\\n  button:hover {\\n    background-color: var(--secondary-highlight-color);\\n  }\\n\\n  .content {\\n    position: relative;\\n    display: flex;\\n    flex-direction: column;\\n    align-items: center;\\n    padding: 2em;\\n  }\\n\\n  .message {\\n    margin-bottom: 1em;\\n  }\\n</style>\\n  \"],\"names\":[],\"mappings\":\"AA8BE,MAAM,eAAC,CAAC,AACN,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,GAAG,CAAC,CAAC,IAAI,CAAC,CACnB,IAAI,CAAE,GAAG,CACT,gBAAgB,CAAE,IAAI,UAAU,CAAC,CACjC,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CAChC,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC5C,WAAW,CAAE,IAAI,MAAM,CAAC,AAC1B,CAAC,AAED,QAAQ,eAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,gBAAgB,CAAE,IAAI,UAAU,CAAC,CACjC,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,MAAM,eAAC,CAAC,AACN,MAAM,CAAE,OAAO,CACf,SAAS,CAAE,GAAG,CACd,WAAW,CAAE,IAAI,MAAM,CAAC,CACxB,gBAAgB,CAAE,IAAI,cAAc,CAAC,CACrC,aAAa,CAAE,GAAG,CAClB,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,OAAO,CAAE,MAAM,CACf,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,gBAAgB,CAAC,KAAK,AACpC,CAAC,AAED,qBAAM,MAAM,AAAC,CAAC,AACZ,gBAAgB,CAAE,IAAI,2BAA2B,CAAC,AACpD,CAAC,AAED,QAAQ,eAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,GAAG,AACd,CAAC,AAED,QAAQ,eAAC,CAAC,AACR,aAAa,CAAE,GAAG,AACpB,CAAC\"}"
};
...
const StartMessage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${ `<div class="${"start svelte-1vlhcvg"}"><div class="${"content svelte-1vlhcvg"}"><div class="${"message svelte-1vlhcvg"}">${slots.default ? slots.default({}) : ``}</div>

      <button class="${"svelte-1vlhcvg"}">Start puzzle</button></div></div>
  <div class="${"curtain svelte-1vlhcvg"}"></div>`
	}`;
});
